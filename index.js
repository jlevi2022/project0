...
const displayStr = `
    ...
    Currently, ${unfundedCount === 1 
        ? "1 game remains" 
        : `${unfundedCount} games remain`
    } unfunded.
...
// grab the elements for the first and second games
const firstGameContainer = document.getElementById("first-game");
const secondGameContainer = document.getElementById("second-game");

// sort the games by pledged amount in descending order
const sortedGames = GAMES_JSON.sort((gameA, gameB) => gameB.pledged - gameA.pledged);
